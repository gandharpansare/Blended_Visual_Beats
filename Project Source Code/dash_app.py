                ...
                dbc.Row(
                    [
                        dbc.Col(
                            ...
                            align="center",
                            children=[
                                dbc.Label("Recommended Playlist - Scatterplot"),
                                dcc.Graph(id="viz-9"),
                            ],
                        ),
                        dbc.Col(
                ...
                dbc.Row(
                    [
                        dbc.Col(
                            ...
                            align="left",
                            children=[
                                dbc.Label("Recommended Playlist - CDF Plot"),
                                dcc.Graph(id="viz-10"),
                            ],
                        ),
                        dbc.Col(
...
viz_titles = {
    ...
    9: "Recommended Playlist - Scatterplot",
    10: "Recommended Playlist - CDF Plot",
}
